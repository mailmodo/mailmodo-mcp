...
export const contactPropertiesSchema = z.object({
  ...
  age: z.number().int().describe("Age of the user in numbers"),
  birthday: dateSchema.describe("Birthdate of the user (ISO format or UNIX timestamp)"),
  phone: z.string().describe("Primary phone number of the user"),
  address1: z.string().describe("Line 1 of the address of the user"),
  address2: z.string().describe("Line 2 of the address of the user"),
  city: z.string().describe("City/district/village of the user"),
  state: z.string().describe("State, region or province of the user"),
  country: z.string().describe("Country of the user"),
  postal_code: z.string().describe("PIN/ZIP Code of the user"),
  designation: z.string().describe("Designation of the user"),
  company: z.string().describe("Company of the user"),
  industry: z.string().describe("Industry of the user"),
  description: z.string().describe("Description of the user"),
  anniversary_date: dateSchema.describe("Anniversary date (ISO format or UNIX timestamp)"),
}).catchall(
